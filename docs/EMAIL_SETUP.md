...
3. API Keys → Create API Key. Restrict it to sending access and the selected domain when the dashboard offers that scope. Copy it once into `wrangler secret put RESEND_API_KEY`.
